...
Endorsement.create(endorser_id: 3, endorsee_id: 2, skill: "cleans well")
Endorsement.create(endorser_id: 4, endorsee_id: 2, skill: "cleans well")
Endorsement.create(endorser_id: 1, endorsee_id: 2, skill: "cleans well")
Endorsement.create(endorser_id: 8, endorsee_id: 1, skill: "pays on time") 
Endorsement.create(endorser_id: 6, endorsee_id: 2, skill: "well organize")
Endorsement.create(endorser_id: 4, endorsee_id: 2, skill: "fun and active")
Endorsement.create(endorser_id: 3, endorsee_id: 1, skill: "listens to instruction")
Endorsement.create(endorser_id: 2, endorsee_id: 1, skill: "listens to instruction")
Endorsement.create(endorser_id: 4, endorsee_id: 1, skill: "listens to instruction")
Endorsement.create(endorser_id: 5, endorsee_id: 1, skill: "listens to instruction")
Endorsement.create(endorser_id: 2, endorsee_id: 1, skill: "works quietly")
Endorsement.create(endorser_id: 8, endorsee_id: 2, skill: "cooks for others")
Endorsement.create(endorser_id: 9, endorsee_id: 1, skill: "handyman")
Endorsement.create(endorser_id: 7, endorsee_id: 1, skill: "repair furniture")
Endorsement.create(endorser_id: 5, endorsee_id: 1, skill: "restock supplies")
Endorsement.create(endorser_id: 4, endorsee_id: 2, skill: "buys groceries for others")
Endorsement.create(endorser_id: 3, endorsee_id: 2, skill: "pays on time")
Endorsement.create(endorser_id: 1, endorsee_id: 2, skill: "work hard")
