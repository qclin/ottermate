...
User.create(name: "thom", gender: "male", hasRoom: true, email: "shea@butter.com", phone: 9179209888 , password: "fireisland", description: "friendly")
User.create(name: "thom2", gender: "female", hasRoom: false, email: "werea@utter.com", phone: 1782038889 , password: "firand", description: "clean")
User.create(name: "thom3", gender: "male", hasRoom: false, email: "swra@tter.com", phone: 9178823459 , password: "fireisl", description: "outgoing")
User.create(name: "thom4", gender: "female", hasRoom: false, email: "tea@ter.com", phone: 9788984569 , password: "reisland", description: "motivated")
User.create(name: "thom5", gender: "female", hasRoom: true, email: "sheeeea@ter.com", phone: 9233898889 , password: "island", description: "active")
User.create(name: "thom6", gender: "male", hasRoom: true, email: "seea@buer.com", phone: 3458333889 , password: "landfireis", description: "vegan")
User.create(name: "thom7", gender: "male", hasRoom: false, email: "shea@butt.com", phone: 9178894248 , password: "fireland", description: "dog-lover")
User.create(name: "thom8", gender: "female", hasRoom: true, email: "swera@buer.com", phone: 9178898779 , password: "fireis", description: "nerd, book-lover")
User.create(name: "thom9", gender: "male", hasRoom: true, email: "shea@ster.com", phone: 1788966689 , password: "island", description: "likes to cook and host parties")
